...
public class CraftingSystem : ItemInterface{
    ...
    public CraftingSystem() {
        ...
        recipe[0, 1] = Item.ItemType.None;     recipe[1, 1] = Item.ItemType.Wood;      
        recipe[0, 0] = Item.ItemType.None;     recipe[1, 0] = Item.ItemType.Wood;

        // Stick (alternative)
       // Item.ItemType[,] recipe = new Item.ItemType[GRID_SIZE, GRID_SIZE];
        //recipe[0, 1] = Item.ItemType.Wood; recipe[1, 1] = Item.ItemType.None;
        //recipe[0, 0] = Item.ItemType.Wood; recipe[1, 0] = Item.ItemType.None;

        /* Need to decide how to restructure these for a 2x2
         * Wood Sword
        ...
        // Steel Sword
        recipe = new Item.ItemType[GRID_SIZE, GRID_SIZE];
        recipe[0, 2] = Item.ItemType.None;     recipe[1, 2] = Item.ItemType.Steel;     recipe[2, 2] = Item.ItemType.None; 
        recipe[0, 1] = Item.ItemType.None;     recipe[1, 1] = Item.ItemType.Steel;     recipe[2, 1] = Item.ItemType.None; 
        recipe[0, 0] = Item.ItemType.None;     recipe[1, 0] = Item.ItemType.Stick;       recipe[2, 0] = Item.ItemType.None;
        recipeDictionary[Item.ItemType.Sword_Steel] = recipe;
        */
    }
