...
public class Item : MonoBehaviour {
    ...
    public int amount = 1;
    private ItemInterface<Item> itemHolder;


    public void SetItemHolder(ItemInterface<Item> itemHolder) {
        this.itemHolder = itemHolder;
    }

    public ItemInterface<Item> GetItemHolder() {
        return itemHolder;
    }
    ...
    public void MoveToAnotherItemHolder(ItemInterface<Item> newItemHolder) {
